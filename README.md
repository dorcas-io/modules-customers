...
The **Customers Module** is a core component of the Dorcas Hub that provides tools for managing customer data.

## features
- Manage Customers Records
- Manage custom fields (additional data like )
- Products & Inventory
...
> Step 2: Click on the **Customers** menu
